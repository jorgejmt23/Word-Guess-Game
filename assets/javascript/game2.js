...
console.log(uniq, your_array)
	  var lettersGuessedArrString = uniq.toString();
	  var lettersGuessedArrEdited = lettersGuessedArrString.replace(/,/g,function myFunction(x){return x.toLowerCase();}," ");
	...
	document.onkeyup = function (event) {
    	...
    	// var text = []
    	// if (text.length < answerLength+8) { 
    		
    	// text.push(letter);
    	// document.getElementById("letters").innerHTML = text.join(", ")
    	// }
